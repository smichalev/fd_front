<template>
  <v-app style="background: #f1f1f1">
    <v-navigation-drawer      v-model="drawer"      :clipped="clipped"      fixed      app>
      ...
      <v-list>
        <v-list-item v-for="(item, i) in menuOne" :key="i" :to="item.to" exact dense>
          <v-list-item-action>
      ...
      <v-list>
        <v-list-item v-for="(item, i) in menuTwo" :key="i" :to="item.to" exact dense>
          <v-list-item-action>
            <v-icon>{{ item.icon }}</v-icon>
          </v-list-item-action>
          <v-list-item-content>
      ...
      <v-list>
        <v-list-item v-for="(item, i) in menuThree" :key="i" :to="item.to" exact dense>
          <v-list-item-action>
            <v-icon>{{ item.icon }}</v-icon>
          </v-list-item-action>
          <v-list-item-content>
    ...
    <v-app-bar :clipped-left="clippedleft" fixed app dense color="#0c42ae" elevation="0">
      ...
      <nuxt-link to="/" tag="div" class="sitename">
        <svg height="496pt" viewBox="0 -40 496.456 496" width="496pt" xmlns="http://www.w3.org/2000/svg" fill="#fff" class="icon">
          ...
          <path d="m95.71875 349.652344 11.3125-11.316406 11.3125 11.316406-11.3125 11.3125zm0 0"/>
          <path d="m126.238281 376.71875 8.894531-13.300781 13.292969 8.886719-8.890625 13.300781zm0 0"/>
          <path d="m161.453125 397.328125 6.125-14.78125 14.78125 6.125-6.125 14.78125zm0 0"/>
          <path d="m200.027344 410.6875 3.125-15.683594 15.679687 3.125-3.125 15.683594zm0 0"/>
          <path d="m348.472656 44.136719 8.894532-13.300781 13.292968 8.886718-8.894531 13.300782zm0 0"/>
          <path d="m314.535156 27.789062 6.125-14.78125 14.78125 6.125-6.125 14.78125zm0 0"/>
          <path d="m278.078125 18.363281 3.117187-15.695312 15.683594 3.117187-3.117187 15.691406zm0 0"/>
          <path d="m400.457031 24.226562h-16v40h-40v16h56zm0 0"/>
          <path d="m112.457031 304.226562h-48v48h16v-32h32zm0 0"/>
          <path d="m248.457031 16.226562h8v-16h-8c-52.648437 0-102.882812 19.714844-141.449219 55.503907l10.886719 11.730469c35.601563-33.039063 81.960938-51.234376 130.5625-51.234376zm0 0"/>
          <path d="m248.457031 400.226562h-8v16h8c73.128907 0 139.550781-37.320312 177.6875-99.832031l-13.65625-8.328125c-35.207031 57.707032-96.527343 92.160156-164.03125 92.160156zm0 0"/>
        </svg>
