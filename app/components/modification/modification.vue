<template>
  <div>
    <v-card
      ...
      outlined
    >
      <div style="position: absolute; top: -5px; right: -5px; z-index: 3" v-if="data.sale">
        <v-chip label color="success" small>-{{ data.sale }}%</v-chip>
      </div>
      ...
      <v-card-actions>
        <div class="d-flex" style="align-items: center">
          ...
          ></v-avatar>
          <div class="font-weight-medium">{{ data.Creater.login }}</div>
        </div>
        <v-spacer></v-spacer>
        <div v-if="data.price > 0">
          <div class="d-flex mr-2" v-if="data.sale" style="align-items: center; font-size: 17px">
          ...
          <div v-if="!data.sale" class="font-weight-bold mr-2" style="color: #4caf50; font-size: 17px">{{ data.price }}
            ₽
          </div>
        </div>
        <div v-else>
